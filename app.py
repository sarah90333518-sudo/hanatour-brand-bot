...
💡 본 챗봇은 **하나투어 브랜드 관련 디자인, 로고, 컬러, 템플릿 및 가이드라인** 정보만 전용으로 안내해 드립니다.
...
with st.sidebar:
    ...
    st.caption("💡 하나투어 브랜드 관련 디자인 & 자산 전용 안내 시스템")
    ...
    categorized_queries = {
        "📘 브랜드 본질 정의서 (v3.0)": [
            ("📐 브랜드 체계 개요", "하나투어 브랜드 체계 개요 알려줘"),
            ("✨ 브랜드 에센스", "하나투어 브랜드 에센스 알려줘"),
            ("🎯 브랜드 미션 & 비전", "하나투어 미션 비전 알려줘"),
            ("💎 브랜드 밸류", "하나투어 브랜드 밸류 알려줘"),
            ("🗣️ 브랜드 퍼스널리티 & 톤오브보이스", "하나투어 퍼스널리티 TOV 알려줘"),
            ("🛡️ 브랜드 신뢰 근거", "하나투어 신뢰 근거 RTB 알려줘"),
            ("📣 브랜드 슬로건", "하나투어 공식 슬로건 알려줘"),
            ("📜 브랜드 매니페스토", "제우스월드 매니페스토"),
        ],
        "🎨 브랜드 기본 자산": [
        ...
        "🏪 공식인증예약센터": [
            ("🏪 간판 설치 규정", "공식인증예약센터 간판 설치 CI 사용 규정"),
            ("📱 SNS 및 콘텐츠 운영 규정", "SNS 운영 규정 알려줘"),
            ("📄 홍보물 PPT 템플릿", "공식인증예약센터 홍보물 PPT 템플릿"),
        ],
        "✈️ 브랜드 체계 & 라인업": [
            ("📐 브랜드 체계도", "하나투어 브랜드 체계도"),
...
if not render_asset_panel():
    ...
    <div class="brand-header">
        ...
        <div class="brand-subtitle">
            💡 본 시스템은 하나투어 브랜드 관련 디자인, 로고, 컬러, 폰트, 간판, 템플릿 및 가이드라인 정보만 전용으로 안내합니다.
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    input_query = st.chat_input("하나투어 브랜드 관련 디자인 및 가이드라인에 대해 질문해 주세요...")
